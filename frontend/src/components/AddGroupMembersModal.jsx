        ...
        <div className="fixed inset-0 bg-black/60 w-full h-screen flex items-center justify-center z-50 backdrop-blur-md p-4">
            <div className="bg-[#f9fafc] rounded-2xl shadow-2xl h-[75dvh] md:h-[85vh] w-full max-w-lg overflow-hidden p-4 md:p-6 flex flex-col">
                ...
                <div className="flex-1 min-h-0 flex flex-col gap-3">
                    ...
                    <form onSubmit={handleAddMembers} className="flex-1 min-h-0 flex flex-col justify-between gap-3">
                        ...
                        <div className="shrink-0 pt-4 border-t border-gray-100 flex justify-between items-center mt-3">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button disabled={selectedMembers.length === 0} type="submit" className="px-5 py-2 bg-[#7678ed] hover:bg-[#5e5ebf] disabled:bg-[#7678ed]/50 disabled:cursor-not-allowed text-white font-medium rounded-md transition-all shadow-md cursor-pointer text-sm md:text-base">Add Members</button>
                            </div>
                        </div>
                    </form>
                </div>
