        ...
        <div className="fixed inset-0 bg-black/60 w-full h-screen flex items-center justify-center z-50 backdrop-blur-md p-4">
            <div className="bg-[#f9fafc] rounded-2xl shadow-2xl h-[90%] w-[40%] overflow-hidden p-6 flex flex-col ">
                <div className="flex justify-between items-start h-[12%]">
                    <div>
                        <h2 className="text-3xl font-semibold text-gray-900 tracking-tight">Remove Members</h2>
                        <p className="text-gray-500 mt-1 text-sm">Select friends to remove from the group.</p>
                    </div>
                ...
                <div className="flex flex-col gap-2 h-[88%]">
                    ...
                    <form onSubmit={handleRemoveMembers} className="flex flex-col gap-2 justify-between h-[90%]">
                        ...
                        <div className="flex justify-between h-[10%] items-center">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button disabled={selectedMembers.length === 0} type="submit" className="px-6 py-2.5 bg-[#7678ed] hover:bg-[#5e5ebf] disabled:bg-[#7678ed]/50 disabled:cursor-not-allowed text-white font-medium rounded-md transition-all shadow-md cursor-pointer text-base">Remove Members</button>
                            </div>
                        </div>
                    </form>
                </div>
