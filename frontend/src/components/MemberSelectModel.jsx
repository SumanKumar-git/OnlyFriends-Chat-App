        ...
        <div className="fixed inset-0 bg-black/60 w-full h-screen flex items-center justify-center z-50 backdrop-blur-md p-4">
            <div className="bg-[#f9fafc] rounded-2xl shadow-2xl h-[90%] w-[40%] overflow-hidden p-6 flex flex-col ">
                <div className="flex justify-between items-start h-[12%]">
                    ...
                    <button onClick={cancleButtonHandler} className="text-gray-400 hover:text-gray-900 hover:bg-[#DCDCFE] p-2.5 rounded-full transition-all cursor-pointer">
                        <X size={22} />
                    </button>
                </div>
                <div className="flex flex-col gap-4 h-[78%] py-4">
                    ...
                    <form className="add-member-container flex flex-col gap-2 mt-2 h-[90%] overflow-y-auto pr-2">
                ...
                <div className="h-[10%] flex justify-between items-center ">
                    ...
                    <div className="flex gap-3">
                        <button onClick={cancleButtonHandler} type="button" className="px-5 py-2.5 rounded-md font-semibold text-gray-600 hover:bg-[#DCDCFE] hover:text-gray-900 transition-all cursor-pointer text-base">Cancel</button>
                        <button disabled={selectedMembers.length === 0} onClick={addMemberButtonHandler} type="button" className="px-6 py-2.5 bg-[#7678ed] hover:bg-[#5e5ebf] disabled:bg-[#7678ed]/50 disabled:cursor-not-allowed text-white font-medium rounded-md transition-all shadow-md cursor-pointer text-base">Add Members</button>
                    </div>
                </div>
            </div>
        </div>
