...
const GroupOutgoingImageBubble = ({isSameSender, message}) => {
    ...
    <div className="w-full flex flex-row justify-end items-center gap-1">
        ...
        <div className={`bg-[#7678ed] w-fit max-w-[70%] cursor-pointer p-1 ${isSameSender ? "rounded-xl" : "rounded-l-xl rounded-br-xl"} flex flex-col gap-1 overflow-hidden`}>
...
export default GroupOutgoingImageBubble