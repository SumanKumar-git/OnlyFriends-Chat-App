        ...
        <div className="w-[70%] h-[85%] shadow-[5px_5px_15px_rgba(0,0,0,0.1)] rounded-4xl flex flex-row justify-center items-center">
            ...
            <div className="h-full w-[50%] rounded-r-4xl p-20 flex flex-col gap-8">
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-gray-700">Please enter your details to access your account.</p>
                </div>
                <form onSubmit={onSubmitHandler} className="flex flex-col gap-5">
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-row items-center bg-[#EDEFF5] p-2.5 gap-3 rounded-xl focus-within:outline-none focus-within:border-gray-300 border-2 border-transparent focus-within:border-2">
                            ...
                            <input className="outline-none w-full " value={email} onChange={(e) => setEmail(e.target.value)} type="email" name="email" id="email" placeholder="alex@john.com" required />
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-row items-center bg-[#EDEFF5] p-2.5 gap-3 rounded-xl focus-within:outline-none focus-within:border-gray-300 border-2 border-transparent focus-within:border-2">
                            ...
                            <input className="outline-none w-full " value={password} onChange={(e) => setPassword(e.target.value)} type="password" name="password" id="password" placeholder="••••••••" required/>
                        </div>
                    </div>
                    <button className="bg-[#3635aa] cursor-pointer text-white p-2.5 mt-2 text-lg rounded-xl font-semibold">Log In</button>
                </form>
                <p className="text-center">Don't have an account? <Link className="text-[#3635aa] cursor-pointer font-semibold" to="/register">Sign Up</Link> </p>
            </div>
